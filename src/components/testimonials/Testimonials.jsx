    ...
    <div className='testimonials' id='testimonials'>
        ...
        <div className="testimonial_one">
                ...
                <div className="test_texts" style={{ background: `url(${TesImage})`}}>
                    <h2 className="tes_title">Onothoja Ruona <br /> <i>Product Manager at Mecho</i></h2>
                    <p className="tes_detail">He takes this work serious, 
                        and never fails to ask questions to be sure on what to do. Top guy to work with.</p>
                </div>
            </div>
