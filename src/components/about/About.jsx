    ...
    <div className="about" id="about">
      ...
      <div className="about_info">
        ...
        <div className="about_details">
          ...
          CSS, SASS, JavaScript, jQuery, React JS, React Native, Redux,
          Typescript, Next JS, GraphQL, Node JS, Express, MongoDB, Mongoose,
          MySQL, Postgres, Prisma and Firebase (BaaS) <br /> <br />I have turned
          UI designs into functional responsive websites using the skills i have
          learnt. I have also used Microsoft technologies such as Microsoft
          sharepoint, Microsoft Azure and Microsoft Power Automate for automated
          workflows.
        </div>
      </div>
    </div>
